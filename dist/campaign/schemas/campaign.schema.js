...
let CampaignAudience = class CampaignAudience {
};
__decorate([
    (0, mongoose_1.Prop)({ type: String, enum: ['all', 'active_clients', 'specific_emails', 'query'], required: true }),
    __metadata("design:type", String)
], CampaignAudience.prototype, "type", void 0);
__decorate([
    (0, mongoose_1.Prop)({ type: Object }),
    __metadata("design:type", Object)
], CampaignAudience.prototype, "query", void 0);
__decorate([
    (0, mongoose_1.Prop)({ type: [String] }),
    __metadata("design:type", Array)
], CampaignAudience.prototype, "specificEmails", void 0);
CampaignAudience = __decorate([
    (0, mongoose_1.Schema)({ _id: false })
], CampaignAudience);
let CampaignSchedule = class CampaignSchedule {
};
__decorate([
    (0, mongoose_1.Prop)({ type: String, enum: ['now', 'scheduled', 'recurring'], required: true }),
    __metadata("design:type", String)
], CampaignSchedule.prototype, "type", void 0);
__decorate([
    (0, mongoose_1.Prop)({ type: Date }),
    __metadata("design:type", Date)
], CampaignSchedule.prototype, "scheduledAt", void 0);
__decorate([
    (0, mongoose_1.Prop)({ type: String }),
    __metadata("design:type", String)
], CampaignSchedule.prototype, "cronExpression", void 0);
__decorate([
    (0, mongoose_1.Prop)({ type: String }),
    __metadata("design:type", String)
], CampaignSchedule.prototype, "timezone", void 0);
CampaignSchedule = __decorate([
    (0, mongoose_1.Schema)({ _id: false })
], CampaignSchedule);
const CampaignAudienceSchema = mongoose_1.SchemaFactory.createForClass(CampaignAudience);
const CampaignScheduleSchema = mongoose_1.SchemaFactory.createForClass(CampaignSchedule);
...
__decorate([
    (0, mongoose_1.Prop)({ type: CampaignAudienceSchema, required: true }),
    __metadata("design:type", CampaignAudience)
], Campaign.prototype, "audience", void 0);
__decorate([
    (0, mongoose_1.Prop)({ type: CampaignScheduleSchema, required: true }),
    __metadata("design:type", CampaignSchedule)
