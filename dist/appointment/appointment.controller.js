...
let AppointmentController = class AppointmentController {
    ...
    async completeAppointment(id, businessId) {
...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 200, description: "Appointment completed, sale recorded" }),
    (0, swagger_1.ApiResponse)({ status: 404, description: "Appointment not found" }),
    __param(0, (0, common_1.Param)('id')),
    __param(1, (0, business_context_decorator_1.BusinessId)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, String]),
