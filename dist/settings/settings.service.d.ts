...
export declare class SettingsService {
    ...
    constructor(settingsModel: Model<BusinessSettingsDocument>, businessModel: Model<BusinessDocument>);
    ...
    findByBusinessIdOrNull(businessId: string): Promise<BusinessSettings | null>;
    findOrCreateDefault(businessId: string): Promise<BusinessSettings>;
