...
// // //     if (appointment.businessId?.toString() !== context.businessId) {
...
// //     // FIX: Access businessInfo.id instead of businessId
// //     const appointmentBusinessId = appointment.businessInfo?.id?.toString() || 
// //                                    appointment.businessInfo?.toString();
    
// //     // Verify appointment belongs to this business
// //     if (appointmentBusinessId !== context.businessId) {
// //       throw new BadRequestException('Appointment does not belong to this business');
// //     }
...
// //       data: {
// //         appointment: {
// //           // FIX: Use toObject() or direct property access for _id
// //           id: (appointment as any)._id || appointmentId,
// //           status: 'cancelled',
// //           cancelledAt: new Date(),
// //           cancelReason: cancelDto.reason
// //         },
