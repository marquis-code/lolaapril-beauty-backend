...
//   async handleJoinRoom(@MessageBody() data: { roomId?: string; businessId?: string; userName?: string; email?: string }, @ConnectedSocket() client: Socket) {
//     const clientInfo = this.connectedClients.get(client.id)
//     if (!clientInfo) return { success: false, error: 'Not connected' }
...
//         // Import chat service dynamically if needed
//         const { ChatService } = await import('../services/chat.service')
//         const chatService = this.moduleRef.get(ChatService, { strict: false })

//         const userInfo: any = {
//           name: data.userName,
//           email: data.email, // Now required for guests
...
//             email: data.email, // Store in guest info
//           }
//         }
...
//   async handleReadMessages(@MessageBody() data: { roomId: string; messageIds: string[] }, @ConnectedSocket() client: Socket) {
//     const clientInfo = this.connectedClients.get(client.id)
//     if (!clientInfo) return
